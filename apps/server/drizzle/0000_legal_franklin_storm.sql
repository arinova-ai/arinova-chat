...
CREATE TYPE "public"."message_status" AS ENUM('pending', 'streaming', 'completed', 'cancelled', 'error');--> statement-breakpoint
...
ALTER TABLE "agents" ADD CONSTRAINT "agents_owner_id_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
