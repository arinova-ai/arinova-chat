  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown:
          "appearance-none bg-transparent text-sm font-medium cursor-pointer border border-input rounded-md px-2 py-1 pr-6 focus:outline-none focus:ring-2 focus:ring-ring",
