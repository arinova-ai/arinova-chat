...
export interface LightingConfig {
  ...
  spot?: { color: string; intensity: number; position: [number, number, number]; target?: [number, number, number]; angle?: number; distance?: number; penumbra?: number; decay?: number };
}
