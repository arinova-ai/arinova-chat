...
- [x] 3.3 Add push trigger in group message handler — send push for group conversation replies
- [x] 3.4 Add push trigger for playground invitation
- [x] 3.5 Add push trigger for playground turn notification
- [x] 3.6 Add push trigger for playground session result
- [x] 3.7 Implement notification deduplication (suppress same-type within configurable window)
...
- [x] 4.3 Initialize default preferences on first push subscription (all enabled, no quiet hours)
...
- [x] 5.1 Build notification permission prompt component (non-intrusive banner with Enable/Later)
- [x] 5.2 Show prompt after first successful login (with 3-day reminder if "Later")
- [x] 5.3 Build iOS Home Screen guidance banner (detect standalone mode, show step-by-step instructions)

## 6. Notification UI — Settings

- [x] 6.1 Add notification section to settings page
- [x] 6.2 Build per-type notification toggles
- [x] 6.3 Build quiet hours picker (start/end time)
- [x] 6.4 Build global notification toggle
- [x] 6.5 Connect settings UI to preferences API
