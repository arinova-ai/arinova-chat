...
export function registerSkill(program: Command): void {
  ...
  skill
    ...
    .action(async () => {
      try {
        const data = await get("/api/skills/my");
  ...
  skill
    ...
    .action(async (opts) => {
      try {
        const data = await post("/api/skills/custom", {
          name: opts.name,
  ...
  skill
    ...
    .action(async (id, opts) => {
      try {
        ...
        await patch(`/api/skills/custom/${id}`, body);
  ...
  skill
    ...
    .action(async (id) => {
      try {
        await del(`/api/skills/custom/${id}`);
  ...
  skill
    ...
    .action(async (skillId, opts) => {
      try {
        await post(`/api/skills/${skillId}/install`, { agentIds: [opts.agent] });
  ...
  skill
    ...
    .action(async (skillId, opts) => {
      try {
        await del(`/api/skills/${skillId}/uninstall?agentId=${opts.agent}`);
