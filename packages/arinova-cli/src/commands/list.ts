...
const TYPE_MAP: Record<ListType, TypeConfig> = {
  ...
  lounge: {
    endpoint: "/api/creator/community?type=lounge",
    extractKey: "communities",
    columns: [
      { key: "id", label: "ID" },
      { key: "name", label: "Name" },
